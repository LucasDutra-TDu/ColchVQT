...
CAMPOS_CATALOGO = {
    "colchones": [
        "STOCK_ACTUAL", "PROVEEDOR", "CÓDIGO", "CODIGO", "MODELO", "MEDIDA (LARG-ANCH-ESP)", "MATERIAL",
        "SOPORTA (PORPLAZA)", "EFECTIVO/TRANSF", "DEBIT/CREDIT", "6 CUOTAS"
    ],
    "otros": [
        "STOCK_ACTUAL", "PROVEEDOR", "CÓDIGO", "CODIGO", "CARACTERISTICAS", "MODELO",
        "EFECTIVO/TRANSF", "DEBIT/CREDIT", "6 CUOTAS"
    ]
}
